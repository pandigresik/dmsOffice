...
class UpdateDmsArCustomercategorytypeRequest extends FormRequest
{
    private $excludeKeys = []; 
    ...
    {
        $permissionName = 'dms_ar_customercategorytype-update';
    ...
    {
        $rules = DmsArCustomercategorytype::$rules;
