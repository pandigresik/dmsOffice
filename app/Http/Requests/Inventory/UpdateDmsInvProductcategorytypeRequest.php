...
class UpdateDmsInvProductcategorytypeRequest extends FormRequest
{
    private $excludeKeys = []; 
    ...
    {
        $permissionName = 'dms_inv_productcategorytype-update';
    ...
    {
        $rules = DmsInvProductcategorytype::$rules;
