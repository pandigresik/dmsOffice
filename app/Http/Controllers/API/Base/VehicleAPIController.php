...
use App\Http\Requests\API\Base\CreateVehicleAPIRequest;
use App\Http\Requests\API\Base\UpdateVehicleAPIRequest;
use App\Http\Resources\Base\VehicleResource;
