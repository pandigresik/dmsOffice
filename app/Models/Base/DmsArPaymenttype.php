...
/**
 * @SWG\Definition(
 *      definition="DmsArPaymenttype",
 *      required={"iId", "szId", "szName", "szDescription", "szPaymentTypeId", "szUserCreatedId", "szUserUpdatedId", "dtmCreated", "dtmLastUpdated"},
 *      @SWG\Property(
 ...
 * )
 */
class DmsArPaymenttype extends Model
{
    use HasFactory;
    ...
    public static $rules = [
        ...
        'szPaymentTypeId' => 'required|string|max:50',
