...
/**
 * @SWG\Definition(
 *      definition="DmsArPaymentterm",
 *      required={"iId", "szId", "szName", "szDescription", "intDueDate", "intDuePrintDate", "szUserCreatedId", "szUserUpdatedId", "dtmCreated", "dtmLastUpdated"},
 *      @SWG\Property(
 ...
 * )
 */
class DmsArPaymentterm extends Model
{
    use HasFactory;
    ...
    public static $rules = [
        ...
        'intDueDate' => 'required|integer',
        'intDuePrintDate' => 'required|integer',
