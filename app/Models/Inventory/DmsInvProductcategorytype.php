...
/**
 * @SWG\Definition(
 *      definition="DmsInvProductcategorytype",
 *      required={"iId", "szId", "szName", "szDescription", "bUseForPriceCalc", "szUserCreatedId", "szUserUpdatedId", "dtmCreated", "dtmLastUpdated"},
 *      @SWG\Property(
 ...
 * )
 */
class DmsInvProductcategorytype extends Model
{
    use HasFactory;
    ...
    public $table = 'dms_inv_productcategorytype';
    ...
    public static $rules = [
        ...
        'bUseForPriceCalc' => 'required|boolean',
