...
/**
 * @SWG\Definition(
 *      definition="DmsInvProductkitinfo",
 *      required={"iId", "szId", "szProductId", "decQty", "szUomId"},
 *      @SWG\Property(
 ...
 * )
 */
class DmsInvProductkitinfo extends Model
{
    use HasFactory;
    ...
    public $table = 'dms_inv_productkitinfo';
