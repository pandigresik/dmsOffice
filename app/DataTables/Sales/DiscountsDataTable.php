...
class DiscountsDataTable extends DataTable
{
    ...
    */
    ...
    {
        return [
            'jenis' => new Column(['title' => __('models/discounts.fields.jenis'), 'data' => 'jenis', 'searchable' => true, 'elmsearch' => 'text']),
            ...
            'main_dms_inv_product_id' => new Column(['title' => __('models/discounts.fields.main_dms_inv_product_id'), 'data' => 'main_dms_inv_product_id', 'searchable' => true, 'elmsearch' => 'text']),
            'main_quota' => new Column(['title' => __('models/discounts.fields.main_quota'), 'data' => 'main_quota', 'searchable' => true, 'elmsearch' => 'text']),
            'bundling_dms_inv_product_id' => new Column(['title' => __('models/discounts.fields.bundling_dms_inv_product_id'), 'data' => 'bundling_dms_inv_product_id', 'searchable' => true, 'elmsearch' => 'text']),
            ...
            'max_quota' => new Column(['title' => __('models/discounts.fields.max_quota'), 'data' => 'max_quota', 'searchable' => true, 'elmsearch' => 'text']),
            'state' => new Column(['title' => __('models/discounts.fields.state'), 'data' => 'state', 'searchable' => true, 'elmsearch' => 'text'])
        ];
    }
