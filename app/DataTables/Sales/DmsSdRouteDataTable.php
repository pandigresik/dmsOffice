...
class DmsSdRouteDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'sales.dms_sd_routes.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DmsSdRoute $model
     *
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DmsSdRoute $model)
    {
    ...
    {
        return 'dms_sd_routes_datatable_'.time();
    }
}
