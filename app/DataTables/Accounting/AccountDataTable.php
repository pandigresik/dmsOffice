...
class AccountDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'accounting.accounts.datatables_actions');
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            'has_balance'  => new Column(['title' => __('models/accounts.fields.has_balance'), 'data' => 'has_balance', 'searchable' => true, 'elmsearch' => 'text']),
