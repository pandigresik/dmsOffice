...
class DmsInvProductitemcategoryDataTable extends DataTable
{
    /**
    ...
    */
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'inventory.dms_inv_productitemcategories.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DmsInvProductitemcategory $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DmsInvProductitemcategory $model)
    {
    ...
    protected function getColumns()
    {
        return [
            ...
            'szCategoryValue' => new Column(['title' => __('models/dmsInvProductitemcategories.fields.szCategoryValue'), 'data' => 'szCategoryValue', 'searchable' => true, 'elmsearch' => 'text'])
        ];
    }
    ...
    {
        return 'dms_inv_productitemcategories_datatable_' . time();
    }
}
