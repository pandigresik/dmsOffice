...
class DmsInvCarriervehicleDataTable extends DataTable
{
    /**
    ...
    */
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'inventory.dms_inv_carriervehicles.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DmsInvCarriervehicle $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DmsInvCarriervehicle $model)
    {
    ...
    protected function getColumns()
    {
        return [
            ...
            'szDriverName' => new Column(['title' => __('models/dmsInvCarriervehicles.fields.szDriverName'), 'data' => 'szDriverName', 'searchable' => true, 'elmsearch' => 'text'])
        ];
    }
    ...
    {
        return 'dms_inv_carriervehicles_datatable_' . time();
    }
}
