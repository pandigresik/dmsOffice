...
class DmsInvCarrierdriverDataTable extends DataTable
{
    /**
    ...
    */
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'inventory.dms_inv_carrierdrivers.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DmsInvCarrierdriver $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DmsInvCarrierdriver $model)
    {
    ...
    {
        return 'dms_inv_carrierdrivers_datatable_' . time();
    }
}
