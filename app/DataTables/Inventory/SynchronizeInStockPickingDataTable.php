...
class SynchronizeInStockPickingDataTable extends DataTable
{
    ...
    */
     ...
     *
     * @param \App\Models\SynchronizeInStockPicking $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(SynchronizeInStockPicking $model)
    {
