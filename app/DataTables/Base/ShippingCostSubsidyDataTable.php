...
class ShippingCostSubsidyDataTable extends DataTable
{
    /**
    ...
    */
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'base.shipping_cost_subsidies.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\ShippingCostSubsidy $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ShippingCostSubsidy $model)
    {
        return $model->with(['product', 'origin'])->select([$model->getTable().'.*'])->newQuery();
    }
    ...
    {
        return 'shipping_cost_subsidies_datatable_' . time();
    }
}
