...
@section('content')
    ...
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item">@lang('models/generalLedger.plural')</li>
    </ol>
    @endpush
    <div class="container-fluid">
        <div class="animated fadeIn">
             ...
             <div class="row">
                    <div class="col-lg-12">
                        {!! Form::open(['route' => 'accounting.generalLedger.index']) !!}
                        <div class="card">
                            <div class="card-header">                                
                                <strong>Rekap @lang('models/generalLedger.singular')</strong>
                            </div>
                            <div class="card-body">                   
                                <!-- Range Period Field -->
                                <div class="form-group row">
                                    {!! Form::label('period_range', __('models/generalLedger.fields.period_range').':', ['class' => 'col-md-3 col-form-label']) !!}
                                    <div class="col-md-9"> 
                                ...
                                <div class="">
                                    <div class="table-responsive" id="listgeneralledger"></div>
                                </div>
