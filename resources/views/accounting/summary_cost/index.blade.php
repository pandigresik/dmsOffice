...
@section('content')
    ...
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item">@lang('models/summaryCost.plural')</li>
    </ol>
    @endpush
    <div class="container-fluid">
        <div class="animated fadeIn">
             ...
             <div class="row">
                    <div class="col-lg-12">
                        {!! Form::open(['route' => 'accounting.summaryCost.index']) !!}
                        <div class="card">
                            <div class="card-header">                                
                                <strong>Rekap @lang('models/summaryCost.singular')</strong>
                            </div>
                            <div class="card-body">                   
                                <!-- Range Period Field -->
                                <div class="form-group row">
                                    {!! Form::label('period_range', __('models/summaryCost.fields.period_range').':', ['class' => 'col-md-3 col-form-label']) !!}
                                    <div class="col-md-9"> 
                                ...
                                <div class="form-group row">                                    
                                    <div class="col-md-6 offset-3">
                                        {!! Form::button(__('crud.process'), ['class' => 'btn btn-success', 'data-target' => '#listcost', 'data-url' => route('accounting.summaryCost.index'), 'data-json' => '{}', 'data-ref' => 'input[name=period_range]' ,'onclick' => 'main.loadDetailPage(this,\'get\')', 'type' => 'button']) !!}
