...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8">
                {!! Form::number('origin_additional_price', null, ['class' => 'form-control', 'required' => 'required'])
                !!}
            </div>
        </div>
    </div>
    <div class="col-md-6">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8">
                {!! Form::number('destination_additional_price', null, ['class' => 'form-control', 'required' =>
                'required']) !!}
            </div>
        </div>
    </div>
