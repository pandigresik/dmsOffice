    ...
    <div class="card-header">Contact
        <div class="card-header-actions">
            ...
            <a class="card-header-action btn-close" href="#" 
                onclick="$(this).closest('div.card').fadeOut();$(this).closest('div.card').find('.form-hidden').append('<input type=\'hidden\' name=\'locationCustomers[{{ $dataCard['id'] }}][stateForm]\' value=\'delete\' >');return false">
