                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <strong>@lang('crud.create')  @lang('models/productCategoriesProducts.singular')</strong>
                            </div>
                            <div class="card-body">                                
            ...
            if(_form.valid()){                                
                ...
                _divWrapper.append(
                    _template.replace('{productId}', _optionSelected[0])
                            ...
                            .replace('{productForm}', main.generateFormField(`productCategoriesProducts[${_idForm}]`, _json).join(''))
                )
