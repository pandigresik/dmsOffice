...
class CreateDmsSdRouteTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dms_sd_route', function (Blueprint $table) {
            ...
            $table->string('szRouteType', 50)->index('IX_DMS_SD_Route_2');
            $table->string('szEmployeeId', 50)->index('IX_DMS_SD_Route_1');
    ...
    {
        Schema::dropIfExists('dms_sd_route');
    }
}
