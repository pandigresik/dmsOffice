...
class CreateDmsArCustomercategoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dms_ar_customercategory', function (Blueprint $table) {
            ...
            $table->string('szCategoryTypeId', 50)->index('IX_DMS_AR_CustomerCategory_1');
    ...
    {
        Schema::dropIfExists('dms_ar_customercategory');
    }
}
