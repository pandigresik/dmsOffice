...
Route::group(['middleware' => ['auth']], function () {
    Route::group(['prefix' => 'base'], function () {
        ...
        Route::resource('productPriceSales', App\Http\Controllers\Base\ProductPriceSalesController::class, ['as' => 'base'])->only(['index', 'create', 'edit', 'store']);
        Route::resource('dmsInvProducts.productPriceSalesLogs', App\Http\Controllers\Base\ProductPriceSalesLogController::class, ['as' => 'base'])->only(['index']);
    });
    ...
    Route::group(['prefix' => 'accounting'], function () {
        ...
        Route::resource('balance', App\Http\Controllers\Accounting\BalanceController::class, ['as' => 'accounting'])->only(['index', 'show']);
        Route::resource('generalLedger', App\Http\Controllers\Accounting\GeneralLedgerController::class, ['as' => 'accounting'])->only(['index', 'show']);        
        Route::resource('moneyCheck', App\Http\Controllers\Accounting\MoneyCheckController::class, ['as' => 'accounting'])->only(['index', 'show', 'update']);        
